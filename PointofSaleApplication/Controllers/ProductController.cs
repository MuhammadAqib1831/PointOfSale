...
namespace PointofSaleApplication.Controllers
{
    public class ProductController : Controller
    {
        ...
        public ActionResult Create([Bind(Include="Id,Name,UnitPrice,Updated")] Product product)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include="Id,Name,UnitPrice,Updated")] Product product)
        {
            if (ModelState.IsValid)
            {
        ...
        public ActionResult Delete(int? id)
        {
            ...
            return PartialView("DeletePartial",product);
        }
